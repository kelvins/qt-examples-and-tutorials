...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QuaGzipFile_t, stringdata) + ofs \
...
const QMetaObject QuaGzipFile::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_QuaGzipFile.data,
      qt_meta_data_QuaGzipFile,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QuaGzipFile.stringdata))
